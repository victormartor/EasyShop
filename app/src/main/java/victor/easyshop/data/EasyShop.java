...
/**
 * Clase con todas las variables globales de la aplicación
...
public class EasyShop extends Application
{
    ...
    public String getIP_Servidor() { return _sIP_Servidor; }
    public void setIP_Servidor(String sIP_Servidor) { _sIP_Servidor = sIP_Servidor; }
